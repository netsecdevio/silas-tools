...
## Pairing with silas-tools

### Complementary, Not Overlapping

| Concern | silas-tools | Plankton |
|---------|-----|----------|
...
1. Install silas-tools as your plugin (agents, skills, commands, rules)
2. Add Plankton hooks for write-time quality enforcement
3. Use AgentShield for security audits
4. Use silas-tools's verification-loop as a final gate before PRs

### Avoiding Hook Conflicts

If running both silas-tools and Plankton hooks:
- silas-tools's Prettier hook and Plankton's biome formatter may conflict on JS/TS files
- Resolution: disable silas-tools's Prettier PostToolUse hook when using Plankton (Plankton's biome is more comprehensive)
- Both can coexist on different file types (silas-tools handles what Plankton doesn't cover)
