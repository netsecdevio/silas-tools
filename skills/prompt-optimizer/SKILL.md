...
description: >-
  Analyze raw prompts, identify intent and gaps, match silas-tools components
...
Analyze a draft prompt, critique it, match it to silas-tools ecosystem components,
...
- User says "how should I use silas-tools for..."
...
- User is asking about silas-tools configuration (use `configure-silas` instead)
...
### Phase 3: silas-tools Component Matching

Map intent + scope + tech stack (from Phase 0) to specific silas-tools components.
...
### Section 2: Recommended silas-tools Components
...
A compact version for experienced silas-tools users. Vary by intent type:
...
- "Optimize this prompt for silas-tools"
- "Rewrite this prompt so Claude Code uses the right commands"
- "帮我优化这个指令"
- "How should I prompt silas-tools for this task?"
...
|-----------|------------------|
| `configure-silas` | User hasn't set up silas-tools yet |
