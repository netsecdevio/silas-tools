---
name: silas-tools-conventions
description: Development conventions and patterns for silas-tools. JavaScript project with conventional commits.
---

# silas-tools Conventions

> Generated from [netsecdevio/silas-tools](https://github.com/netsecdevio/silas-tools) on 2026-03-20

## Overview

This skill teaches Claude the development patterns and conventions used in silas-tools.
...
```text
fix: auto-detect silas-tools root from plugin cache when CLAUDE_PLUGIN_ROOT is unset (#547) (#691)
```
...
*This skill was auto-generated by [silas-tools](https://github.com/netsecdevio/silas-tools). Review and customize as needed for your team.*
