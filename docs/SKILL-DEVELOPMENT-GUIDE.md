...
A comprehensive guide to creating effective skills for silas-tools.
...
| `origin` | No | Source identifier (e.g., `silas-tools`, `community`, project name) |
...
```bash
gh repo fork netsecdevio/silas-tools --clone
cd silas-tools
```
